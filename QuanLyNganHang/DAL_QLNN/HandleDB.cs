...
namespace QuanLyNganHang.DAL_QLNN
{
    public class HandleDB
    {
        ...
        {
            string connectionStrType = String.Format(@"Data Source=.\SQLEXPRESS;Initial Catalog=QUANLYNGANHANG;Integrated Security=True", Environment.MachineName);
            ...
            {
                connectionStrType = String.Format(@"Data Source={0}\SQLEXPRESS;Initial Catalog=QUANLYNGANHANG;Integrated Security=True", Environment.MachineName);
        ...
        /*public void LoginCheck()
        {
            ...
            DataTable result = HandleDB.Instance.ExecuteQuery(query);
